...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_60_iso_arrow(
        ...
        _______, DF(0),   DF(1),   _______, _______, _______, _______, KC_WBAK, KC_WSTP, KC_WREF, KC_WFWD, _______, _______, _______,
        _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, _______, KC_MSTP, KC_MPLY, KC_MPRV, KC_MNXT, _______, KC_PGUP, _______,
